...
s32 sunxi_lcd_dsi_dcs_write_10para(u32 screen_id, u8 command, u8 para1, u8 para2,
					u8 para3, u8 para4, u8 para5, u8 para6, u8 para7, u8 para8,
					u8 para9, u8 para10)
{
	u8 tmp[10];
	...
	tmp[8] = para9;
	tmp[9] = para10;
	sunxi_lcd_dsi_dcs_write(screen_id, command, tmp, 10);

	return -1;
}

s32 sunxi_lcd_dsi_dcs_write_11para(u32 screen_id, u8 command, u8 para1, u8 para2,
					u8 para3, u8 para4, u8 para5, u8 para6, u8 para7, u8 para8,
					u8 para9, u8 para10, u8 para11)
{
	u8 tmp[11];
	...
	tmp[9] = para10;
	tmp[10] = para11;
	sunxi_lcd_dsi_dcs_write(screen_id, command, tmp, 11);

	return -1;
}

s32 sunxi_lcd_dsi_dcs_write_12para(u32 screen_id, u8 command, u8 para1, u8 para2,
					u8 para3, u8 para4, u8 para5, u8 para6, u8 para7, u8 para8,
					u8 para9, u8 para10, u8 para11, u8 para12)
{
	u8 tmp[12];
	...
	tmp[10] = para11;
	tmp[11] = para12;
	sunxi_lcd_dsi_dcs_write(screen_id, command, tmp, 12);

	return -1;
}

s32 sunxi_lcd_dsi_dcs_write_15para(u32 screen_id, u8 command, u8 para1, u8 para2,
						u8 para3, u8 para4, u8 para5, u8 para6, u8 para7, u8 para8,
						u8 para9, u8 para10, u8 para11, u8 para12, u8 para13,
						u8 para14, u8 para15)
{
	u8 tmp[15];
	...
	tmp[13] = para14;
	tmp[14] = para15;
	sunxi_lcd_dsi_dcs_write(screen_id, command, tmp, 15);

	return -1;
}

s32 sunxi_lcd_dsi_dcs_write_16para(u32 screen_id, u8 command, u8 para1, u8 para2,
						u8 para3, u8 para4, u8 para5, u8 para6, u8 para7, u8 para8,
						u8 para9, u8 para10, u8 para11, u8 para12, u8 para13,
						u8 para14, u8 para15, u8 para16)
{
	u8 tmp[16];
	...
	tmp[14] = para15;
	tmp[15] = para16;
	sunxi_lcd_dsi_dcs_write(screen_id, command, tmp, 16);
