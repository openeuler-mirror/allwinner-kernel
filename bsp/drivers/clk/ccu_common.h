...
#define CCU_FEATURE_CHANGE_PARENT	BIT(13)

/* Enable pll lock after change pll rate */
#define CCU_FEATURE_PLL_LOCK_ENABLE	BIT(14)

/* Disable pll lock before change pll rate */
#define CCU_FEATURE_PLL_LOCK_DISABLE	BIT(15)

/* Workaround for setting pll p-factor */
#define CCU_FEATURE_PLL_WORKAROUND	BIT(16)

/* MMC timing mode switch bit */
#define CCU_MMC_NEW_TIMING_MODE		BIT(30)

#define	SWITCH_PARENT_TO_TEMP	0
#define	SWITCH_PARENT_TO_NORMAL	1
...
struct ccu_common {
	...
	u32		key_value;
	u32		clear;
	void		(*change_parent)(struct clk_hw *hw, int index);
...
void ccu_helper_wait_for_lock_atomic(struct ccu_common *common, u32 lock);
